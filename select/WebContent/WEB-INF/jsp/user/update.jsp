                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/user/update" method="post" id="userForm">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="account" id="account" value="${user.account }" placeholder="请输入新增用户账号">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="user_name" id="user_name" value="${user.user_name }" placeholder="输入用户的真实姓名">
                                    	<i id="usernameError"><small>不超过三位字符</small></i>
                                    </div>
                                </div>
                                ...
                                <div>
									...
									<!-- 判断部门名称是否修改 -->
									<input type="hidden" id="old_account" value="${user.account }" >
                                </div>
                            </form>
                        </div>
                    </div>
