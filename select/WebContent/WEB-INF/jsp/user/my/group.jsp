    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="javascript:;">我的小组管理</a></li>
                <li class="am-active">小组列表</li>
            </ol>
                                    ...
                                    <tbody>
                                    	<c:forEach items="${title }" var="title" varStatus="vs">
                                    		<tr>
										        ...
										        <td>${title.user.user_name }</td>
										        <td><c:if test="${title.student.student_id==null }" var="flag">
									                  <span style="color: green; font-weight: bold;">未选</span>
									                </c:if> 
									                <c:if test="${!flag }">
									                   <span style="color: red;">已被${title.student.student_name }选择</span>
									                </c:if>
												</td>         
												<td>
                                                	<div class="am-btn-toolbar">
                                                   		<div class="am-btn-group am-btn-group-xs">
                                                        	...
                                                        	<a href="sys/title/update/${title.title_id}"><li class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o">编辑</span> </li></a>
                                                        	<a href="javascript:;" onclick="doDelete('${title.title_id}')"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
                                                   		</div>
                                                	</div>
                                           		</td>
									         </tr>
