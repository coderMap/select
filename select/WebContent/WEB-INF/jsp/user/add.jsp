                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/user/add" method="post" id="userForm">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="user_name" id="user_name" placeholder="输入用户的真实姓名">
                                    	<i id="usernameError"><small>不超过三位有效数字</small></i>
                                    </div>
                                </div>
	...
	<script type="text/javascript">
	   $(function(){
		   $("#btn").on("click",function(){
               ...
               if(account===""){
                   $("#accountError").css("color","red").html("用户名称不能为空");
                   $("#account").focus();
                   return false;
               }
