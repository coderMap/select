    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="javascript:;">用户信息管理</a></li>
                <li class="am-active">用户修改密码</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>用户修改密码
                    </div>
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/user/update" method="post" id="userForm">
                            	<div class="am-form-group">
	                            	<label for="user-name" class="am-u-sm-3 am-form-label">原密码</label>
	                                <div class="am-u-sm-9">
	                                    <input type="password" name="password" id="password"  placeholder="输入用户的真实姓名">
	                                    <i id="pderror"><small>请输入您原来的密码</small></i>
	                                </div>
	                            </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" name="" id="new_password" placeholder="请输入新增用户账号">
                                        <i id="npderror"><small>新密码</small></i>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" name="" id="ValidNew_password" placeholder="输入用户的真实姓名">
                                    	<i id="vnpderror"><small>确认新的密码</small></i>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="button" id="btn" class="am-btn am-btn-primary">保存修改</button>
                                    </div>
                                </div>
                                <div>
                                	<!--更新操作需要隐藏域-->
									<input type="hidden" id="user_id" value="${session_user.user_id }">
                                </div>
                            </form>
                        </div>
                    </div>
		...
		$(function() {
			$("#btn").on(
					...
					function() {
						...
						var ValidNew_password = $.trim($("#ValidNew_password").val());
						//判断原密码是否为空
						if (password == '') {
							$("#pderror").css("color", "red").html(
									"原密码不能为空!,请重新输入.");
							return;
						}
						...
						//判断新密码是否为空
						if (new_password == '') {
							$("#npderror").css("color", "red").html(
									"新密码不能为空!,请重新输入.");
							return;
						}

						//判断确认新密码是否为空
						if (ValidNew_password == '') {
							$("#vnpderror").css("color", "red").html(
									"确认密码不能为空!,请重新输入.");
							return;
						}

						//判断新密码与确认新密码是否相同
						if (new_password != ValidNew_password) {
							$("#vnpderror").css("color", "red").html(
									"两次输入的新密码不同!,请重新输入.");
							return;
						}

						$.get("sys/user/selPassword", {
							user_id : user_id
						}, function(data) {
							//判断原密码与输入密码是否相同
							if (data != password) {
								...
								$.get("sys/user/updPassword", {
									...
									if (data.flag == "success") {
										...
										$("#pderror").css("color", "red").html(data.message);
										$("#password").focus();
										return false;
									}
								});
