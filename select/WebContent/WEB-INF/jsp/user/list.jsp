                    ...
                    <div class="tpl-portlet-input tpl-fz-ml">
                        <div class="portlet-input input-small input-inline">
                            <div class="input-icon right">
                            	<form class="form-search" action="sys/user/list" method="get" id="searchForm">
									<!-- 隐藏域信息 -->
												...
												<td>
                                                	<div class="am-btn-toolbar">
                                                   		<div class="am-btn-group am-btn-group-xs">
                                                    		<a href="sys/user/add/"><li class="am-btn am-btn-default am-btn-xs am-hide-sm-only"></li><span class="am-icon-copy"></span>新增 </a>
                                                        	<a href="sys/user/update/${datas.user_id}"><li class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o">编辑</span> </li></a>
                                                        	<a href="javascript:;" onclick="doDelete('${datas.user_id}')"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
                                                   		</div>
                                                	</div>
                                           		</td>
									         </tr>
