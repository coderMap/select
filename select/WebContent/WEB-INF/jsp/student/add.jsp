                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/student/add" method="post" id="studentForm">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">账号</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="account" id="account" placeholder="请输入新增用户账号">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="student_name" id="student_name" placeholder="输入用户的真实姓名">
                                    	<i id="usernameError"><small>不超过三位有效字符</small></i>
                                    </div>
                                </div>
                                
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">用户密码</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="password" placeholder="输入用户的密码">
                                    </div>
                                </div>
	...
	<script type="text/javascript">
	   $(function(){
		   $("#btn").on("click",function(){
               ...
               if(account===""){
                   $("#accountError").css("color","red").html("用户账号不能为空");
                   $("#account").focus();
                   return false;
               }
               
               if(student_name===""){
                   $("#usernameerror").css("color","red").html("用户名称不能为空");
                   $("#student_name").focus();
                   return false;
               }
               //验证账号是否重复
