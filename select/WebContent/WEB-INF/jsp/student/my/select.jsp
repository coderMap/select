    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="javascript:;">毕业设计在线选题</a></li>
                <li class="am-active">学生在线选题</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>学生在线选题
                    </div>
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/student/select" method="post" >
	
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">学生姓名</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="student_name" id="student_name" value="${student.student_name }" placeholder="输入用户的真实姓名" disabled="disabled">
                                    </div>
                                </div>
                                
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">请选择毕设题目</label>
                                    <div class="am-u-sm-9">
                                    	<select class="dfinput" name="title_id">
                                    		<option value="">---请选择---</option>
											<c:forEach items="${title }" var="title" varStatus="vs">
												<option value="${title.title_id }">${title.title_name }</option>
											</c:forEach>
										</select>
										<i id="error"><small style="color: red;">注意:一经选题之后，不可修改</small></i>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                	<c:if test="${student.title.title_name==null }" var="flag">
										<div class="am-form-group">
                                    		<div class="am-u-sm-9 am-u-sm-push-3">
                                        		<button type="submit" class="am-btn am-btn-primary">点击选题</button>
                                    		</div>
                               			</div>
									</c:if> 
									<c:if test="${!flag }">
									<i id="error"><span style="color: red;">提示 : </span></i>
									     <span style="color: blue;">您已选题完毕，选题结果：${student.title.title_name}</span>
									</c:if>
								</div>
