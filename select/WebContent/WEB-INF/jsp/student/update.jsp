...
<body data-type="index">
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="javascript:;">学生信息管理</a></li>
                <li class="am-active">学生修改</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>学生修改
                    </div>
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/student/update" method="post" id="studentForm">
                                
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">账号</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="account" id="account" value="${student.account }" placeholder="请输入新增用户账号">
                                        <i id="accountError"><small>字母、数字和下划线组成</small></i>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="student_name" id="student_name" value="${student.student_name }" placeholder="输入用户的真实姓名">
                                    	<i id="usernameError"><small>不超过三位有效字符</small></i>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                    	<select class="dfinput" name="class_name">
                                    		<option value="">${student.class_name }</option>
											<c:forEach items="${class_name }" var="class_name"
												varStatus="vs">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="phone" value="${student.phone }" placeholder="输入手机号">
                                    </div>
                                </div>
                                ...
                                <div>
									...
									<!-- 判断部门名称是否修改 -->
									<input type="hidden" id="old_account" value="${student.account }" >
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    $(function(){
        $("#btn").on("click",function(){
            ...
            if(account===""){
                $("#accountError").css("color","red").html("账号能为空");
                $("#account").focus();
                return false;
            }
            ...
            if(account==old_account){
            	...
            	$.get("sys/user/validAccount",{account:account},function(data){
                    if(data.flag=="success"){
                        ...
                        $("#accountError").css("color","red").html(data.message);
                        $("#account").focus();
                        return false;
                    }
                });
