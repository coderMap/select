                    ...
                    <div class="tpl-portlet-input tpl-fz-ml">
                        <div class="portlet-input input-small input-inline">
                            <div class="input-icon right">
                            	<form class="form-search" action="sys/student/list" method="get" id="studentForm">
									<!-- 隐藏域信息 -->
                                    ...
                                    <tbody>
                                    	<c:forEach items="${pager.datas }" var="datas" varStatus="vs">
                                    		<tr>
										        ...
										        <td>${datas.sex }</td>
										        <td>${datas.phone }</td>
										        <td><c:if test="${datas.title.title_name==null }" var="flag">
									                  <span style="color: red;">该生未选题</span>
									                </c:if> 
									                <c:if test="${!flag }">
									                   <span style="color: blue;">${datas.title.title_name }</span>
									                </c:if>
												</td> 
										        <td>${datas.user.user_name }</td>
										        <td><c:if test="${datas.status=='1' }" var="flag">
									                  <span style="color: green; font-weight: bold;">在校</span>
									                </c:if> 
									                <c:if test="${!flag }">
									                   <span style="color: red;">已休学</span>
									                </c:if>
												</td>         
												<td>
                                                	<div class="am-btn-toolbar">
                                                   		<div class="am-btn-group am-btn-group-xs">
                                                    		<a href="sys/student/add/"><li class="am-btn am-btn-default am-btn-xs am-hide-sm-only"></li><span class="am-icon-copy"></span>新增 </a>
                                                        	<a href="sys/student/update/${datas.student_id}"><li class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o">编辑</span> </li></a>
                                                        	<a href="javascript:;" onclick="doDelete('${datas.student_id}')"><button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button></a>
                                                   		</div>
                                                	</div>
                                           		</td>
									         </tr>
