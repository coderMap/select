...
<body data-type="index">
    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">题目修改</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>题目修改
                    </div>
                ...
                <div class="tpl-block ">
                    <div class="am-g tpl-amazeui-form">
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="sys/title/update" method="post" id="titleForm">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">题目名称</label>
                                    <div class="am-u-sm-9">
                                     	<input type="text" name="title_name" id="title_name" value="${title.title_name }" placeholder="请输入题目名称">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="title_desc" id="title_desc" value="${title.title_desc }" placeholder="请输入题目描述">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <option value="">${title.user.user_name }</option>
                                ...
                                <div>
									...
									<!-- 判断部门名称是否修改 -->
									<input type="hidden" id="old_title_name" value="${title.title_name }" >
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    $(function(){
        $("#btn").on("click",function(){
            ...
            if(title_name===""){
                $("#error").css("color","red").html("题目名不能为空");
                $("#title_name").focus();
                return false;
            }
            
            var old_title_name =$("#old_title_name").val();
            if(title_name==old_title_name){
            	 $("#titleForm").submit();
                return; 
            }else{
                //验证用户姓名是否重复
